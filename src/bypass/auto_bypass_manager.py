#!/usr/bin/env python3
"""
Auto Bypass Manager for FRP Freedom
...
class AutoBypassManager:
    ...
    def _determine_optimal_mode(self, device: DeviceInfo) -> str:
        ...
        # For devices in Fastboot mode, prefer booting to Android for interface methods
        ...
        # Qualcomm devices: EDL mode or fastboot
